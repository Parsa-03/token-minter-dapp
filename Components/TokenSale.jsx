        ...
        <div className="col-lg-6 offset-lg-3 col-md-12 col-sm-12">
          <div className="title_default_light title_border text-center">
            ...
            <p className="animation"
              data-animation="fadeInUp"
              data-animation-delay="0.2s">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore sunt, reiciendis debitis necessitatibus nisi ipsam tempora suscipit quasi magnam quisquam, molestiae cum.
            </p>
          </div>
        </div>
      </div>

      <div className="row align-ietms-center">
              ...
              <div className="tk_counter_inner">
                ...
                >
                  ...
                  <span className="progress_label bg-white inline_style_1">
                    <strong>
                      {tokenSale?.tokenSold} TBC
                    </strong>
                  </span>
                  <span className="progress_label bg-white inline_style_2">
                    <strong>
                      {tokenSale?.tokenSaleBalance} TBC
                    </strong>
                  </span>
