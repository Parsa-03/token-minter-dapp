        ...
        <div className="col-lg-6 col-md-12 col-sm-12 order-lg-first">
          <div className="banner_text_s2 text_md_center">
            <h1 className="animation text-white"
              ...
              data-animation-delays="1.1s">
              <strong>Bitcoin</strong> is peer to peer electronic cash <strong>system</strong>
            </h1>
            <h5 className="animation presale_txt text-white"
              data-animation="fadeInUp"
              data-animation-delays="1.3s">
              Token Presale is <mark className="gradient_box">Live</mark>
            </h5>
            <div className="btn_group pt-2 pb-3 animation"
              data-animation="fadeInUp"
              data-animation-delays="1.4s">
            ...
            <div id="whitepaper" className="team_pop mfp-hide">
              <div className="row m-0">
                <div className="col md-7">
                  <div className="pt-3 pb-3">
                    <div className="title_dark title_border">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur vero totam sunt dolor optio tempora, sapiente quibusdam, sint vitae ratione, alias quidem magnam quas. Rem dolorum quae porro esse quibusdam.
                      </p>
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem blanditiis consequuntur dolores, quasi sequi fuga dolorum rem. Exercitationem ea, eligendi ut tempora reprehenderit nostrum. Dolorem dolor autem voluptatum laborum soluta.
                      </p>

                      <a href="" className="btn btn-default btn-radius">Download Now
                ...
                <div className="col-md3">
                  <img src="assets/images/whitepaper.png" alt="whitepaper" className="pt-3 pb-3" />
                </div>
              </div>
            </div>
          </div>
